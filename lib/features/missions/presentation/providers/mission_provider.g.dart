...
String _$crewMissionsHash() => r'40aeb9e23ef7ca1a33b1445ba87198c36ba24066';

/// See also [crewMissions].
@ProviderFor(crewMissions)
const crewMissionsProvider = CrewMissionsFamily();

/// See also [crewMissions].
class CrewMissionsFamily extends Family<AsyncValue<List<CrewMission>>> {
  /// See also [crewMissions].
  const CrewMissionsFamily();

  /// See also [crewMissions].
  CrewMissionsProvider call(
    String crewId,
  ) {
    return CrewMissionsProvider(
      crewId,
    );
  }

  @override
  CrewMissionsProvider getProviderOverride(
    covariant CrewMissionsProvider provider,
  ) {
    return call(
      provider.crewId,
    );
  ...
  @override
  String? get name => r'crewMissionsProvider';
}

/// See also [crewMissions].
class CrewMissionsProvider
    extends AutoDisposeFutureProvider<List<CrewMission>> {
  /// See also [crewMissions].
  CrewMissionsProvider(
    String crewId,
  ) : this._internal(
          (ref) => crewMissions(
            ref as CrewMissionsRef,
            crewId,
          ),
          from: crewMissionsProvider,
          name: r'crewMissionsProvider',
          debugGetCreateSourceHash:
              const bool.fromEnvironment('dart.vm.product')
                  ? null
                  : _$crewMissionsHash,
          dependencies: CrewMissionsFamily._dependencies,
          allTransitiveDependencies:
              CrewMissionsFamily._allTransitiveDependencies,
          crewId: crewId,
        );

  CrewMissionsProvider._internal(
    super._createNotifier, {
    required super.name,
    required super.dependencies,
    required super.allTransitiveDependencies,
  ...
  @override
  Override overrideWith(
    FutureOr<List<CrewMission>> Function(CrewMissionsRef provider) create,
  ) {
    return ProviderOverride(
      origin: this,
      override: CrewMissionsProvider._internal(
        (ref) => create(ref as CrewMissionsRef),
        from: from,
        name: null,
        dependencies: null,
        allTransitiveDependencies: null,
  ...
  @override
  AutoDisposeFutureProviderElement<List<CrewMission>> createElement() {
    return _CrewMissionsProviderElement(this);
  }

  @override
  bool operator ==(Object other) {
    return other is CrewMissionsProvider && other.crewId == crewId;
  }
...
@Deprecated('Will be removed in 3.0. Use Ref instead')
// ignore: unused_element
mixin CrewMissionsRef on AutoDisposeFutureProviderRef<List<CrewMission>> {
  /// The parameter `crewId` of this provider.
  String get crewId;
}

class _CrewMissionsProviderElement
    extends AutoDisposeFutureProviderElement<List<CrewMission>>
    with CrewMissionsRef {
  _CrewMissionsProviderElement(super.provider);

  @override
  String get crewId => (origin as CrewMissionsProvider).crewId;
}
